...
function paginationLinks($current_page, $total_pages, $base_url) {
	...
	if ($current_page == 1) {
		...
		$html .= '<li class="disabled"><a>Pierwsza</a></li>';
	} else {
		$html .= '<li><a href="' . $base_url . $http_query . '&page=1">Pierwsza</a></li>';
	}
	...
	if ($current_page == $total_pages) {
		$html .= '<li class="disabled"><a>Ostatnia</a></li>';
	} else {

		$html .= '<li><a href="' . $base_url . $http_query . '&page=' . $total_pages . '">Ostatnia</a></li>';
	}
